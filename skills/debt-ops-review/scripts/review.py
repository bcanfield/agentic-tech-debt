...
Portable Agent Skill (Agent Skills open standard). Audit signals (deterministic,
Git-as-oracle):
...
Logic is kept byte-identical to the adapter copies so the planned `_common.py`
extraction (ADR 0011 / packaging plan Phase E) is a clean lift.
"""
...
# Read the cached registry-dir path; default if missing.
